...
<div class="col-sm-12">
    ...
    <form:form method="POST"
               action="/create_user" modelAttribute="editUser">
        ...
        <div class="form-group">
            ...
            <form:input path="login" class="form-control" id="login" placeholder='${placeholder}' name="login"  required ="required" />
        </div>
        <div class="row">
            <div class="col">
                <div class="form-group">
                    <label for="pass"><spring:message code="user.creer.pass.value"/>*</label>
                    <form:input path="pass" class="form-control" id="pass" name="password" type="password"   required ="required" />
                </div>
            </div>
            <div class="col">
                <div class="form-group">
        ...
        <div class="form-group">
            ...
            <form:input path="dateDeNaissance" type="date"   class="form-control date" id="date"  name="date"   required ="required"/>
        </div>
